 ...
 * @author X1
 */
public class QLTT_Material extends javax.swing.JFrame {
    SVGImage svgSet = new SVGImage();
    SanPhamService spService = new SanPhamService();
    /**
     * Creates new form QLTT_Brand
     */
    public QLTT_Material() {
        initComponents();
    ...
    public SP_KichCo getModel(){
        int pos = tblMaterial.getSelectedRow();
        
        SP_KichCo sz = new SP_KichCo();
        sz.setIdSz((Integer) tblMaterial.getValueAt(pos, 0));
    ...
    private void initComponents() {
        ...
        jLabel2.setText("THÔNG TIN CHẤT LIỆU");
    ...
    private void btnAdd_BMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAdd_BMouseClicked
        //ADD 
        int result = JOptionPane.showConfirmDialog(this, "Bạn muốn thêm mới chất liệu?", "POLYPOLO xác nhận", JOptionPane.YES_NO_OPTION);   
        if (result == JOptionPane.YES_OPTION && validateThuocTinh()) {
            JOptionPane.showMessageDialog(this, spService.addSz(getModel()));
            loadTable(spService.getListSz());
        }else{
            JOptionPane.showMessageDialog(this, "Đã hủy thao tác thêm mới chất liệu!", "POLYPOLO thông báo", 0);
        }
    ...
    private void btnUpdate_BMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdate_BMouseClicked
        ...
        if (selectedRow == -1) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn chất liệu bạn muốn cập nhật!", "POLYPOLO thông báo", JOptionPane.WARNING_MESSAGE);
        } else {
    ...
    private void btnHide_BMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnHide_BMouseClicked
        ...
        int selectedRow = tblMaterial.getSelectedRow();
        if (selectedRow == -1) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn chất liệu bạn muốn ẩn!", "POLYPOLO thông báo", JOptionPane.WARNING_MESSAGE);
        } else {
    ...
    private void btnUnhide_BMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUnhide_BMouseClicked
        ...
        int selectedRow = tblMaterial.getSelectedRow();
        if (selectedRow == -1) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn chất liệu bạn muốn bỏ ẩn!", "POLYPOLO thông báo", JOptionPane.WARNING_MESSAGE);
        } else {
    ...
    private void tblMaterialMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMaterialMouseClicked
        ...
        int selectedRow = tblMaterial.getSelectedRow();        
        if (selectedRow != -1) {
            Integer idBrand = Integer.valueOf(tblMaterial.getValueAt(selectedRow, 0).toString());
            String szName = tblMaterial.getValueAt(selectedRow,1).toString();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QLTT_Material().setVisible(true);
            }
        });
    }
