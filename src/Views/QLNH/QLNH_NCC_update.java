 ...
 * @author X1
 */
public class QLNH_NCC_update extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 470, -1, 50));
    ...
    private void btnEditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditMouseClicked
        // UPDATE
        int result = JOptionPane.showConfirmDialog(this, "Bạn muốn sửa nhà cung cấp này?", "POLYPOLO xác nhận", JOptionPane.YES_NO_OPTION);
        if (result == JOptionPane.YES_OPTION && myValidate()) {
            String resultNek = nccService.updateNCC(getModel());
            JOptionPane.showMessageDialog(this, resultNek);
        } else {
            JOptionPane.showMessageDialog(this, "Đã hủy thao tác sửa nhà cung cấp!", "POLYPOLO thông báo", 0);
        }
        clearForm();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QLNH_NCC_update().setVisible(true);
            }
        });
    }
